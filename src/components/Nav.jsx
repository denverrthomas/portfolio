...
const Nav = () => {
    ...
    return ( 
        <div>
            ...
            <nav className={`${navbarOpen ? "flex absolute h-screen bg-white z-1 p-3 text-right top-0 right-0 w-80 z-9 transition duration-1000 transform translate-x-0" : "flex absolute h-screen bg-white z-1 p-3 text-right top-0 right-0 w-80 z-9 transition duration-1000 transform translate-x-full"}`}>
